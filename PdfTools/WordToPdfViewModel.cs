...
/// <summary>
/// ViewModel for the Word-to-PDF tool detail view.
/// Handles file picking, background execution, and status reporting.
/// </summary>
public partial class WordToPdfViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private string _statusText = "Select a .docx file to convert.";
    ...
    public WordToPdfViewModel(DispatcherQueue dispatcherQueue)
    {
    ...
    private async Task ConvertAsync()
    {
        ...
        var engine  = new LibreOfficeEngine();
        ...
        try
        {
            ...
            if (result.IsSuccess)
            {
                Services.HistoryService.Instance.AddItem(OutputFilePath, "Word to PDF", "\uEA90");
            }
            ...
            _dispatcherQueue.TryEnqueue(() =>
            {
                ...
                IsConverting = false;
                // Keep IsStatusVisible true to show the result
            });
        }
        catch (Exception ex)
        {
